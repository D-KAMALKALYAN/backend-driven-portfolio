...
/** The columns fetchActiveResume selects, as a test fixture may supply them. */
interface ResumeRowFixture {
...
vi.mock('../services/supabaseClient', () => ({
  supabase: {
    from: (table: string) => {
      ...
      const chain: any = {
        select: (cols: string) => { state.selected = cols; return chain; },
        eq: () => chain,
